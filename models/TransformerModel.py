...
from models.model_utils import PositionalEncoding, SelfAttentionPooling
...
class TransformerModel(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward, nlayers, n_conv_layers=2, n_class=2, dropout=0.5, dropout_other=0.1):
        ...
        self.fc_out1 = torch.nn.Linear(d_model+d_model, d_model)
        self.fc_out2 = torch.nn.Linear(d_model, 1) # if two classes problem is binary
        # self.init_weights()
    ...
    def forward(self, src, src2=None):
