...
def evaluate_12ECG_score(args, output_directory):#(label_directory, output_directory):
    ...
    # Return the results.
    return classes, auroc, auprc, auroc_all, auprc_all, accuracy, accuracy_all, f_measure, f_measure_all, f_beta_measure, f_beta_all, g_beta_measure, g_all, challenge_metric, confusion_matrices
